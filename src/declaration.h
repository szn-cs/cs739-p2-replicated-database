  ...
  */
  class Consensus {
   public:
    ...
    map<string, map<int, databaseInterface::LogEntry>> Get_Log();  // Returns current log and db snapshots
    ...
    std::map<std::string, app::Node> cluster;  // map of addresses to stubs
