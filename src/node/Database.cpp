...
/*
    RPC handlers
*/
Status Database::get(ServerContext* context, const databaseInterface::Request* request, databaseInterface::Response* response) {
...
Status Database::set(ServerContext* context, const databaseInterface::Request* request, databaseInterface::Response* response) {
...
map<string, vector<databaseInterface::LogEntry>> Database::Get_Log(){
  return pax_log;
}
